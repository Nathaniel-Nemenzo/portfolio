  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200">
       ...
       <hr/>
       <p>
        When relaxing, I love spending time with friends and family. I also enjoy going on walks with my girlfriend, playing the piano, drawing, and taking photos. Recently, I've taken an interest in walkable environments and architecture. <br/><br/>
