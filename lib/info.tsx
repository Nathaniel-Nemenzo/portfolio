...
export const bio = () => {
  return (
    <>
      Previously, I've interned at Amazon and NASA. I've also spent time in the Learning Agents Research Group at UT Austin. Outside of school and work, I'm also interested in urban environments and architecture. <br/><br/>
